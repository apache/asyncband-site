...
- When the pull request is closed, the cleanup workflow deletes the `site/<name>-staging` branch and its staged preview goes offline. To remove a stale staging preview by hand, delete its `site/<name>-staging` branch.
